...
let blogName = "Alea Aquarius Chaos Blog";
let authorName = "Eddie";
let authorLink = "https://deepintheforest.neocities.org/"; // Enter your website, social media, etc. Some way for people to tell you they like your blog! (Leaving it empty is okay too)
...
[ "posts/01-06-2024-Gedanken-zum-Inhaltsverzeichnis.html" ] ,
[ "posts/30-05-2024-Reaktion-zur-Leseprobe.html" ] ,
[ "posts/06-10-2023-Fanfiktion-Ideen.html" ] ,
[ "posts/13-10-2023-Gedanken-zu-9.1.html" ] ];
...
let headerHTML = 
'<ul> <li><a href="' + relativePath + '/index.html">Startseite</a></li>' + 
'<li><a href="' + relativePath + '/archive.html">Archiv</a></li>' +
'<li><a href="' + relativePath + '/about.html">Über mich</a></li> </ul>';
...
let footerHTML = "<hr><p>" + blogName + " ist geschrieben von <a href='" + authorLink + "'>" + authorName + "</a>, gebaut mit <a href='https://zonelets.net/'>Zonelets</a>, und gehostet mit <a href='https://neocities.org/'>Neocities</a>! <a href='https://deepintheforest.neocities.org/archive#Credits'>Weitere Kedits</a> </p>";
...
if ( currentIndex > -1 ) {
  ...
  if (  postDateFormat.test ( postsArray[currentIndex][0].slice( 6,17 ) ) ) {
    ...
    let month = "";
    if ( monthSlice === "01") { month = "Januar";}
    else if ( monthSlice === "02") { month = "Februar";}
    else if ( monthSlice === "03") { month = "März";}
    ...
    else if ( monthSlice === "12") { month = "Dezember";}
...
let recentPostListHTML = "<h2>Neue Blogeinträge:</h2><ul>";
